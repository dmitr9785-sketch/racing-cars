...
const PONY_BIOMES = [
  ...
  },
  {
    ...
    grassColor: new THREE.Color(0x0a1a0a),
    grass2Color: new THREE.Color(0x050f05),
    fogColor: new THREE.Color(0x000008),
    skyColor: new THREE.Color(0x000008),
    barrierColor: new THREE.Color(0x0a1a2a),
    postColor: new THREE.Color(0x0a1a2a),
    ambientColor: new THREE.Color(0x101030),
