...
const PONY_BIOMES = [
  ...
  },
  {
    name: 'Pony-Sky',
    distanceStart: 2000,
    roadColor: new THREE.Color(0x1a2a3a),
    grassColor: new THREE.Color(0x1a3a2a),
    grass2Color: new THREE.Color(0x0a2a1a),
    fogColor: new THREE.Color(0x0a0a2a),
    skyColor: new THREE.Color(0x0a0a2a),
    barrierColor: new THREE.Color(0x1a2a3a),
    postColor: new THREE.Color(0x1a2a3a),
    ambientColor: new THREE.Color(0x202050),
    hemiSkyColor: new THREE.Color(0x1a1a4a),
    hemiGroundColor: new THREE.Color(0x0a0a2a),
